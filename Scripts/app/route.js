var Berth = (function () {
    function Berth(area, berth, text, abbr) {
        this.area = area;
        this.berth = berth;
        this.abbr = abbr;
    ...
    Berth.empty = function (text, abbr) {
            ...
            webApi.getBerthContents(berth.uniqueIdentifier).done(function (data) {
                if (data) {
                    ...
                    if (data.m_Item3) {
                        ...
                        webApi.getTrainMovementByUid(data.m_Item3.TrainUid, ts.format(TrainNotifier.DateTimeFormats.dateUrlFormat)).done(function (tm) {
                        });
                    }
                }
                else {
